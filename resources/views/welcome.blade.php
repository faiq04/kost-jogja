    ...
    <div
        ...
        <body id="page-top">
            ...
            <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark" id="mainNav">
                <div class="container">
                    <a class="navbar-brand" href="#page-top"><img src="{{ asset('img/kost.png') }}"
                            alt="..." /></a>
                ...
                <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/header-bg.jpg" width="100%" height="100%"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card shadow-sm">
                                    <img src="img/kosan1.jpg" width="100%" height="225"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                ...
                                                <a href="#" class="btn btn-sm btn-success">kost jogja</a></h3>
                                                </h3>
                            ...
                            <div class="col">
                                <div class="card shadow-sm">
                                    <img src="img/kosan2.jpg" width="100%" height="225"
                                        xmlns="http://www.w3.org/2000/svg" role="img"
                                        aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice"
                                        focusable="false">
                                    <title>Placeholder</title>
                            ...
                            <div class="col">
                                <div class="card shadow-sm">
                                    <img src="img/kosan3.jpg" width="100%" height="225"
                                        xmlns="http://www.w3.org/2000/svg" role="img"
                                        aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice"
                                        focusable="false">
                                    <title>Placeholder</title>
                            ...
                            <section class="page-section" id="about">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <img src="img/rumah1.jpeg" width="250" height="150"
                                            xmlns="http://www.w3.org/2000/svg" role="img"
                                        ...
                                        <h3 class="section-subheading text-muted">kost jogja barat <p>Rp 7.500.000 </p>
                                            ...
                                            <a href="{{ route('pesan1') }}" class="btn btn-sm btn-success">Detail</a>
                                        </h3>
                                        </h3>

                                    </div><!-- /.col-lg-4 -->
                                    <div class="col-lg-3">
                                        <img src="img/rumah2.jpg" width="250" height="150"
                                            xmlns="http://www.w3.org/2000/svg" role="img"
                                            aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice"
                                            focusable="false">
                                        <title>Placeholder</title>
                                        <h3 class="section-subheading text-muted">kost jogja timur <p>Rp 9.500.000 </p>
                                            <a href="#" class="btn btn-sm btn-primary">Tambah ke keranjang</a>
                                            <a href="{{ route('pesan2') }}" class="btn btn-sm btn-success">Detail</a>
                                        </h3>
                                        </h3>

                                    </div><!-- /.col-lg-4 -->
                                    <div class="col-lg-3">
                                        <img src="img/rumah3.jpg" width="250" height="150"
                                            xmlns="http://www.w3.org/2000/svg" role="img"
                                            aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice"
                                            focusable="false">
                                        <title>Placeholder</title>
                                        <h3 class="section-subheading text-muted">kost jogja selatan <p>Rp 10.500.000
                                            </p>
                                            <a href="#" class="btn btn-sm btn-primary">Tambah ke keranjang</a>
                                            <a href="{{ route('pesan3') }}" class="btn btn-sm btn-success">Detail</a>
                                        </h3>
                                        </h3>

                                    </div><!-- /.col-lg-4 -->
                                    <div class="col-lg-3">
                                        <img src="img/rumah4.jpg" width="250" height="150"
                                            xmlns="http://www.w3.org/2000/svg" role="img"
                                            aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice"
                                            focusable="false">
                                        <title>Placeholder</title>
                                        <h3 class="section-subheading text-muted">kost jogja utara <p>Rp 7.500.000 </p>
                                            <a href="#" class="btn btn-sm btn-primary">Tambah ke keranjang</a>
                                            <a href="{{ route('pesan4') }}" class="btn btn-sm btn-success">Detail</a>
                                        </h3>
                        ...
                        <div class="row">
                            <div class="container">
                                <iframe width="1000" height="500"
                                    ...
                                    width="1500" height="600" style="border:0;" allowfullscreen=""
                        ...
                        <div class="row">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="close-modal" data-bs-dismiss="modal"><img
                                                src="{{ asset('tamplate/assets/img/close-icon.svg') }}"
                                                alt="Close modal" /></div>
                                        <div class="container">
                            ...
                            <div class="portfolio-modal modal fade" id="portfolioModal5" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="close-modal" data-bs-dismiss="modal"><img
                                                src="{{ 'tamplate/assets/img/close-icon.svg' }}"
                                                alt="Close modal" /></div>
                                        <div class="container">
                                            <div class="row justify-content-center">
                                                <div class="col-lg-8">
